...
public class Project {
   public static void main(String[] args) {
    try {
            String re = "\u001B[0m", bl = "\u001B[30m", r = "\u001b[31;1m", g = "\u001B[32m",y = "\u001B[33m",b = "\u001B[34m", p = "\u001B[35m", c = "\u001B[36m", R = "\u001B[41m",G = "\u001B[42m",C = "\u001B[46m", W = "\u001B[47m";
            int choice = -1;
            Scanner s1 = new Scanner(System.in);
            Scanner s2 = new Scanner(System.in);
            File file = new File("C:/Users/rajth/OneDrive/Desktop/Application.txt");
            ArrayList<Customer> al = new ArrayList<Customer>();
            ObjectOutputStream oos = null;
            ObjectInputStream ois = null;
            ListIterator li = null;
            
            File file2 = new File("C:/Users/rajth/OneDrive/Desktop/History.txt");
            ArrayList<History> al2 = new ArrayList<History>();
            ObjectOutputStream oos2 = null;
            ObjectInputStream ois2 = null;
            ListIterator li2 = null;
            
            File file3 = new File("C:/Users/rajth/OneDrive/Desktop/Loan.txt");
            ...
            switch (n2) {
               case 1:
                ...
                try {
                  ...
                  switch (choice) {
                  case 1:
                  System.out.println("\n\t\t    " + y+ "---------| Create New Customer Account |----------"+ re+ "\n");
                  System.out.println("\t" + W + bl + "  Saving Account  " + re + "         " + W + bl + "  Current Account  " + re + "         " + W + bl + "        Exit       " + re);
                  System.out.println("\t" + W + bl + "         1        " + re + "         " + W + bl + "         2         " + re + "         " + W + bl + "         3         " + re + "\n");
                  int n3 = s1.nextInt();
                  if(n3==1||n3==2||n3==3){
                    switch (n3) {
                      case 1:
                        System.out.println("\n\t\t\t" + y+ "---------| Create New Saving Account |----------"+ re+ "\n");
                        for (int i = 0; i < 1; i++) {
                          System.out.print("\n\t\t\t\tEnter Name            : ");
                      ...
                      case 2:
                        System.out.println("\n\t\t\t" + y+ "---------| Create New Current Account |----------"+ re+ "\n");
                        for (int i = 0; i < 1; i++) {
                          System.out.print("\n\t\t\t\tEnter Name            : ");
                          String name = s2.nextLine();
                          System.out.print("\n\t\t\t\tEnter Password        : ");
